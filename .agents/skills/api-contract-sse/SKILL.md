...
10. List endpoints for async jobs should document supported filters and pagination semantics, and keep heavy per-item detail, such as audit history, off the summary response unless explicitly needed.
