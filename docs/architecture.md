...
- the board's quick-view presets now cover pending queues, queue-oriented slices, terminal success slices, reason slices, and task-type slices while still writing back into the same filter form and URL state
