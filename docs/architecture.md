...
- the board's quick-view presets now cover both queue-oriented slices and task-type slices while still writing back into the same filter form and URL state
