...
- once the dataset queue action is canonical, the dataset list/detail should also expose a lightweight linked-case summary so operators can see owner and latest status before opening `/admin/cases`
