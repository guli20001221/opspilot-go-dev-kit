...
2. target `/admin/eval-reports?tenant_id=...&report_id=...&bad_case_needs_follow_up=true`
3. keep the handoff hidden when `bad_case_without_open_follow_up_count == 0`
4. cover it in eval-report page runtime smoke
