...
- when operators need to release claimed work back into a shared open queue, prefer row-level or detail actions that reuse a canonical case unassign endpoint over treating an empty assignee as a special assign payload
