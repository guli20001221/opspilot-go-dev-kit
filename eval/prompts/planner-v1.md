...
- A list of available tools with their properties (name, read_only, requires_approval, async_only)
- The request mode ("chat" for conversational, "task" for async task execution)
- Tenant policy (whether tool use is allowed)
